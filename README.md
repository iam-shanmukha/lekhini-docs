...
Public documentation and GitHub Pages site for [Lekhini](https://play.google.com/store/apps/details?id=com.shanmukhavishnu.lekhini) — a journal-first writing app for Telugu and English writers.
...
3. Set **Branch** to `master`, folder `/` (root).
4. Save. GitHub Pages will publish the site at the URL above within a few minutes.
